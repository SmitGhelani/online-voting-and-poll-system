	...
	<head>	
		...
		<?php
			...
			if($_SERVER["REQUEST_METHOD"] == "POST")
			{
				...
				{
					$clone=mysqli_query($conn,"select `user_name` from user_data");
				...
				{
					$clone1=mysqli_query($conn,"select `phone no` from user_data");
				...
				{
					$clone2=mysqli_query($conn,"select `email` from user_data");
				...
				{
					$query="INSERT INTO `user_data`(`user_name`, `age`, `phone no`, `email`, `gender`, `address`, `password`) VALUES ('$uname','$age','$phone','$email','$gender','$add','$pass');";
